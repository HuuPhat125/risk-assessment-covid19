...
class LogisticRegressionTrainer:
    ...
    def train(self, X_train, y_train, X_val, y_val, output_dir: Path):
        ...
        logger.info(f"Training Logistic Regression with parameters: {self.config.get('params', {})}")
        ...
        plot_learning_curve(train_losses, val_losses, train_accuracies, val_accuracies, output_dir)
